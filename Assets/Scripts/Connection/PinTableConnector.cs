...
public class PinTableConnector : MonoBehaviour
{
    ...
    public void SendPackages()
    {
        ...
        for (var i = 0; i < manager.Packages.GetLength(0); i++)
        {
            ...
            StartCoroutine(SendMessageToIDCoroutine(i, manager.Packages[i]));
        }
    }
}
